		...
		>
			<div className="flex flex-col-reverse items-center gap-8 lg:flex-row lg:gap-10">
				...
				<div
					data-aos="fade-left"
					data-aos-duration="600"
					className="flex flex-col items-center lg:items-start w-full lg:w-[50%] gap-2 lg:gap-3 leading-9"
				>
					...
					<Link
						to="/signup"
						className="flex text-white rounded-[8px] w-full sm:w-[300px] hover:hover:bg-[#6fa7fc] lg:w-[400px] h-[48px] text-center justify-center items-center sm:h-[58px] bg-[#034AB3] mx-auto lg:mx-0 transition-all duration-500 ease-in-out mt-4"
					>
						Sign Up
					</Link>
					{/* Icons */}
